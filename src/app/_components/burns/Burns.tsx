...
const Burns = ({ data, isCarbon, isLipid, isCalorie, isProtein }: Props) => {
    ...
    if (isCalorie) {
      return (
        <div className={styles.wrapper}>
          ...
          <div className={styles.content}>
            <p className={styles.number}>{data} KCal</p>
            <p className={styles.origin}>Calories</p>
          </div>
        </div>
      );
    } else if (isLipid) {
      return (
        <div className={styles.wrapper}>
          ...
          <div className={styles.content}>
            ...
            <p className={styles.origin}>Lipides</p>
          </div>
        </div>
      );
    } else if (isProtein) {
      return (
        <div className={styles.wrapper}>
          ...
          <div className={styles.content}>
            <p className={styles.number}>{data}g</p>
            <p className={styles.origin}>Proteines</p>
          </div>
        </div>
      );
    } else if (isCarbon) {
      return (
        <div className={styles.wrapper}>
          ...
          <div className={styles.content}>
            <p className={styles.number}>{data}g</p>
            <p className={styles.origin}>Glucides</p>
          </div>
        </div>
      );
    } else {
  ...
  }, [data, isCarbon, isLipid, isCalorie, isProtein]);
